...
export const albums: Album[] = [
  {
    ...
    description:
      "Why must we <u>trifle</u>, age and <u>spoil</u>? How has lady Nature granted me the gift of God's Nectar, and still yet, She <u>poisons</u> us from within when we attempt to <u>cope</u> by it's <u>consumption</u>?",
