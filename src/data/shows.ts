...
export const shows: Show[] = [
  {
    ...
    posterImg: '/media/posters/jims-alibi-01192026.png',
    price: '$15',
    ...
    meta: {
      ...
      openGraphImage: '/media/posters/jims-alibi-01192026.png',
  ...
  },
  {
    ...
    posterImg: '/media/shows/rm-block-party.png',
    price: '00.00',
    ...
    meta: {
      ...
      openGraphImage: '/media/shows/rm-block-party.png',
      twitterCard: 'summary_large_image',
      structuredData: {
        "@context": "https://schema.org",
        "@type": "Event",
